...
class AccessibilityManager(private val context: Context) {
    ...
    companion object {
        ...
        private const val TTS_QUEUE_FLUSH_DELAY = 100L
    }
    ...
    private fun initializeTextToSpeech() {
        textToSpeech = TextToSpeech(context) { status ->
            if (status == TextToSpeech.SUCCESS) {
                ...
                Log.e(TAG, "Error inicializando TextToSpeech")
    ...
    /**
     * Anuncia un mensaje usando TalkBack o TTS
     */
    fun announceForAccessibility(message: String, priority: Int = AccessibilityEvent.TYPE_ANNOUNCEMENT) {
        ...
        // Intentar usar TalkBack primero
     ...
     */
    fun setupCaptureButtonAccessibility(button: View, canCapture: Boolean, state: CaptureValidationManager.GuideState) {
        val description = if (canCapture) {
