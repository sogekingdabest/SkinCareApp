...
/**
 * Tests unitarios para CaptureGuidanceOverlay
 * Verifica la funcionalidad básica del overlay de guías visuales
 */
...
class CaptureGuidanceOverlayTest {
    ...
    fun `overlay se inicializa correctamente`() {
        ...
        // El overlay debe tener un estado inicial
    ...
    fun `updateMolePosition con null limpia posición`() {
        // Primero establecer una posición
