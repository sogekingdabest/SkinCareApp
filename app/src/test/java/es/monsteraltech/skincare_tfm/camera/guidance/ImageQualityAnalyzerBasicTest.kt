...
/**
 * Tests básicos para ImageQualityAnalyzer sin dependencias complejas de OpenCV
 * Verifica la estructura y lógica básica de la clase
 */
...
class ImageQualityAnalyzerBasicTest {
    ...
    fun `QualityMetrics should prioritize blur message over exposure`() {
        ...
        // El mensaje de desenfoque debería tener prioridad
    ...
    fun `QualityMetrics should prioritize underexposure over overexposure`() {
        ...
        // El mensaje de subexposición debería tener prioridad sobre sobreexposición
